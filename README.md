...
2.  **Build/Cache Folders**
    - `.next`, `dist`, `build`, `storybook-static`, `.nuxt`, `.output`, `.svelte-kit`, `.angular`, `out`, `.expo`, `.turbo`, `.cache`, `.shopify`, `.react-router`, `.tanstack`, `.vite-ssg-temp`, `.wwebjs_cache`, `.wwebjs_auth`, `.eslintcache`, `.stylelintcache`, `.tsbuildinfo`, `.swc`, `.sass-cache`,
