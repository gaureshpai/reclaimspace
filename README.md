...
2.  **Build/Cache Folders**
    - `.next`, `dist`, `build`, `storybook-static`, `.nuxt`, `.output`, `.svelte-kit`, `.angular`, `out`, `.expo`, `.turbo`, `.cache`, `.shopify`, `.react-router`, `.tanstack`, `.rollup.cache`, `.parcel-cache`, `.vite`, `.astro`, `.solid`, `.remix`, `.docusaurus`, `.eleventy-cache`, `.gatsby-cache`, `.wwebjs_cache`, `.wwebjs_auth`, `.eslintcache`, `.stylelintcache`, `.tsbuildinfo`, `.swc`, `.sass-cache`, `public/build`
